...
/***/ function(module, exports, __webpack_require__) {
	...
	var CommentForm = React.createClass({
	  ...
	  render: function render() {
	    return React.createElement(
	      ...
	      React.createElement('input', { type: 'text', placeholder: 'Your comment', value: this.state.text, onChange: this.handleTextChange }),
	      React.createElement('br', null),
	...
	ReactDOM.render(React.createElement(CommentBox, { url_reload: 'http://127.0.0.1:3000/api/articles', pollInterval: 2000, url: 'http://127.0.0.1:3000/api/addArticle' }), document.getElementById('content'));
